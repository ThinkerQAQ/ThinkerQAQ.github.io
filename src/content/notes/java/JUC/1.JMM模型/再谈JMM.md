---
title: "6.23 再谈JMM"
description: "了解了计算机底层知识后，再来看JMM就容易多了 1. 为什么需要JMM 之前提到过内存模型规定了程序的内存操作（读操作和写操作）所有可能的执行顺序中哪些是正确的，而不同的处理器架构有不同的内存模型，Java作为一个跨平台（OS和硬件）的语言，为了屏蔽底层的这些差异，定义了自己的内存模型：JMM 2."
sourcePath: "Java/JUC/1.JMM模型/再谈JMM.md"
category: "java"
categoryLabel: "Java"
topic: "JUC"
topicLabel: "6.JUC"
...
updatedAt: "2020-03-01T11:11:51Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
- [啃碎并发（11）：内存模型之重排序 \- 掘金](https://juejin.im/post/5bd971096fb9a0222205d56e)
- [Java 内存模型 JMM 深度解析 \- 掘金](https://juejin.im/post/5a27ab3851882546d71f36e1)
