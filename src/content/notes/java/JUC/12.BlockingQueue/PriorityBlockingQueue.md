---
title: "6.41 PriorityBlockingQueue"
description: "1. 是什么 底层使用数组（二叉堆）实现的无界的阻塞队列 读读、读写、写写相互阻塞 可以排序 由于无界，所以put操作不会阻塞，但是take操作会阻塞（队列为空的时候） 1.1. 二叉堆 一颗完全二叉树，堆序性质为，每个节点的值都小于其左右子节点的值，二叉堆中最小的值就是根节点。 底层用数组进行存储"
sourcePath: "Java/JUC/12.BlockingQueue/PriorityBlockingQueue.md"
category: "java"
categoryLabel: "Java"
topic: "JUC"
topicLabel: "6.JUC"
...
updatedAt: "2020-01-18T06:30:23Z"
status: "historical"
language: "zh"
featured: false
indexable: true
