---
title: "6.5 5.AQS"
description: "1. 是什么 队列同步器，用于实现JUC包的其他并发工具类 2. 如何使用 一般我们不直接使用AQS，而是使用JUC中的其他工具类（如CountDownLatch等），这些工具类覆盖了几乎所有的使用场景，只有在这些工具类无法满足我们的需求时，才去用AQS实现自己的并发工具。 实现的一般的套路如下： "
sourcePath: "Java/JUC/5.AQS/5.AQS.md"
category: "java"
categoryLabel: "Java"
topic: "JUC"
topicLabel: "6.JUC"
...
updatedAt: "2020-02-17T07:42:59Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 3. 原理分析
可以先阅读[手写AQS.md](/notes/java/JUC/5.AQS/%E6%89%8B%E5%86%99AQS/)以便更好的理解AQS源码
