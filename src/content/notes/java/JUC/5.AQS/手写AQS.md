---
title: "6.25 手写AQS"
description: "我们可以自己动手写一个简单的AQS，以更好地理解AQS实际的源码 1. 需求 1. 锁是排他的，一旦这个锁被某个线程占有，只要这个锁没被释放，他就不能被其他线程占有。因此需要保存当前占有锁的线程 2. 要有一个单独的字段表示当前锁的状态，是空闲还是已被占有 3. 同一时间有很多线程抢占锁，只有一个线"
sourcePath: "Java/JUC/5.AQS/手写AQS.md"
category: "java"
categoryLabel: "Java"
topic: "JUC"
topicLabel: "6.JUC"
...
updatedAt: "2020-01-18T06:27:21Z"
status: "historical"
language: "zh"
featured: false
indexable: true
