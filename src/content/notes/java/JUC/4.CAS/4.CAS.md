---
title: "6.4 4.CAS"
description: "1. 是什么 要理解CAS，我们首先得了解乐观锁和悲观锁的概念。 1.1. 乐观锁与悲观锁 悲观锁：假设每次操作数据的时候总有人一起操作数据。因此我操作数据前先上锁，直到我操作完释放锁，别人都只能阻塞等待。 乐观锁：假设每次操作数据的时候没人跟我一起操作数据。因此我只在更新的时候检查一下有没有其他人"
sourcePath: "Java/JUC/4.CAS/4.CAS.md"
category: "java"
categoryLabel: "Java"
topic: "JUC"
topicLabel: "6.JUC"
...
updatedAt: "2020-01-18T06:26:39Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 2. 如何使用
JUC包中Atomic类的实现都是通过CAS实现的，参考[Atomic.md](/notes/java/JUC/4.CAS/Atomic/Atomic/)
