---
title: "5.3 ArrayList"
description: "1. 是什么 底层由数组实现的，可扩容的顺序表 有序、可以重复 2. 如何使用 3. 原理分析 3.1. uml 可以看出ArrayList是个List、可克隆、可序列化、可以使用下标访问 3.2. 构造方法 使用object数组，并且初始化长度为0 3.3. add方法 - 不扩容O（1），扩容O"
sourcePath: "Java/JDK/List/ArrayList.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-16T15:41:25Z"
status: "historical"
language: "zh"
featured: false
indexable: true
