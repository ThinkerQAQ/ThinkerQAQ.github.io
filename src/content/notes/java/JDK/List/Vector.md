---
title: "5.25 Vector"
description: "1. 是什么 线程安全的list 2. 如何使用 3. 源码分析 3.1. uml 可以看出是个List，可以克隆，可以序列化，可以使用下标访问 3.2. 构造方法 默认初始化长度为10，扩容时候的增量为两倍 3.3. add方法 不扩容的时候O（1），扩容O（N） 3.3.1. 加了synchro"
sourcePath: "Java/JDK/List/Vector.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-11T07:38:15Z"
status: "historical"
language: "zh"
featured: false
indexable: true
