---
title: "5.2 Integer"
description: "1. 使用 2. 原理分析 2.1. 构造方法 Integer是不可变的，所谓的不可变是指： - 类使用final修饰 - 内部属性value使用final修饰 - 没有对外提供修改内部属性value的方法 2.2. valueOf方法 2.2.1. 范围正在-128-127的从缓存中取 - Int"
sourcePath: "Java/JDK/Integer/Integer.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-16T14:26:50Z"
status: "historical"
language: "zh"
featured: false
indexable: true
