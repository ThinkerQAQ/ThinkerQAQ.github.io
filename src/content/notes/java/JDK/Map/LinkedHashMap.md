---
title: "5.11 LinkedHashMap"
description: "1. 是什么 - 使用双向链表+HashMap（数组+链表+红黑树）实现 - 相比于HashMap保存了顺序 - 迭代时输出的顺序是 - 按照插入节点的顺序来输出 - 也可以指定成按照访问的顺序输出(LRU) 2. 使用 - 按照插入节点的顺序来输出 - 按照访问的顺序输出 3. 实现 3.1. u"
sourcePath: "Java/JDK/Map/LinkedHashMap.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-17T05:39:11Z"
status: "historical"
language: "zh"
featured: false
indexable: true
