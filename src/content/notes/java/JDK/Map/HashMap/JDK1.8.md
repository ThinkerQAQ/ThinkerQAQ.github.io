---
title: "5.28 JDK1.8"
description: "1. 是什么 实现O(1)存取效率的key-value对数据结构 2. 如何使用 3. 原理分析 3.1. uml 可克隆，可序列化，实现了Map 3.2. 构造方法 3.3. put方法 总体伪算法如下： - 计算key的hash值 - 使用hash值&数组长度1计算改数据存放的位置i - tab"
sourcePath: "Java/JDK/Map/HashMap/JDK1.8.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-17T04:10:00Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 3.3.2. 第一次进来table肯定为空，那么扩容
## 5. 参考
- [HashMap几个刁钻的面试题，第六个我就跪了 \- 知乎](https://zhuanlan.zhihu.com/p/87929020)
- [3分钟让你明白 HashMap之红黑树树化过程 \- 掘金](https://juejin.im/post/5d9fbd72e51d45781a677c87)
