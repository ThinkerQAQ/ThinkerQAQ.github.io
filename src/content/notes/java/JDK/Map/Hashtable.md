---
title: "5.4 Hashtable"
description: "1. 是什么 线程安全的hashmap 2. 如何使用 3. 原理分析 3.1. uml 可克隆，可序列化，实现了Map接口 3.2. 构造方法 使用链地址法（单链表）解决Hash冲突 初始化容量为11，默认的加载因子为0.75 3.3. put方法 3.3.1. 使用synchronized加锁 "
sourcePath: "Java/JDK/Map/Hashtable.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-01-22T15:04:35Z"
status: "historical"
language: "zh"
featured: false
indexable: true
