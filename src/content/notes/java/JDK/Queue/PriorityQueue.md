---
title: "5.6 PriorityQueue"
description: "1. PriorityQueue是什么 是一个队列，只不过加上了优先级的概念，换句话说队列里的元素是根据某种规则排好序的 2. 使用 - 输出 3. 源码分析 3.1. 属性 3.2. 有参构造 - initFromCollection 可以看出主要有两个步骤，一个是建立初始化元素到数组中，另一个是"
sourcePath: "Java/JDK/Queue/PriorityQueue.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
order: 128
tags: ["Java"]
createdAt: "2020-03-07T03:46:22Z"
updatedAt: "2020-03-07T06:59:17Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 4. 参考
- [计算机程序的思维逻辑 \(46\) \- 剖析PriorityQueue \- 掘金](https://juejin.im/post/582e43b6a0bb9f0067adbade)
