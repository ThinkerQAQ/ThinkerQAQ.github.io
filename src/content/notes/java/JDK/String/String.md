---
title: "5.9 String"
description: "1. 是什么 不可变、线程安全的字符串 2. 使用 3. 源码分析 3.1. 类的定义 String是不可变的 - 类使用final修饰 - 内部属性char value[]使用final修饰，说明引用不能改变 - 且内部没有对外提供修改内部属性char value[]的方法 3.2. 构造方法 3"
sourcePath: "Java/JDK/String/String.md"
category: "java"
categoryLabel: "Java"
topic: "JDK"
topicLabel: "5.JDK"
...
updatedAt: "2020-02-16T15:30:41Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
#### 3.8.1. 解释new String("test4").intern() == "test4"
```java
String val7 = new String("test4");
String val8 = "test4";
String val7Intern = val7.intern();
