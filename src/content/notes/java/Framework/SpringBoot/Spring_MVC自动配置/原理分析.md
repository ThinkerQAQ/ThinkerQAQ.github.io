---
title: "2.38 原理分析"
description: "1. spring-boot-starter-web预先导入的自动配置类 - @WebMvcAutoconfiguration WebMvcAutoConfigurationAdapter是Spring Boot开启web mvc自动配置的类，如下 - 里面有一个静态内部配置类， WebMvcAut"
sourcePath: "Java/Framework/SpringBoot/Spring_MVC自动配置/原理分析.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-19T03:23:03Z"
status: "historical"
language: "zh"
featured: false
indexable: true
