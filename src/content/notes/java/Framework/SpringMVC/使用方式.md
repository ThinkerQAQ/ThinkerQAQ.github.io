---
title: "2.12 使用方式"
description: "新建项目 第一种方式 新建web项目 导入jar包依赖 在WEB-INF下新建lib目录，导入如下依赖。并且add as library 第二种方式 新建maven工程 添加web框架支持 maven pom 依赖 修改project配置lib包 配置spring mvc - WEB-INF/web"
sourcePath: "Java/Framework/SpringMVC/使用方式.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
