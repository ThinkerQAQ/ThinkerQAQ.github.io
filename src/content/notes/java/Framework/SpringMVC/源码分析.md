---
title: "2.14 源码分析"
description: "1. 打断点 我们在com.zsk.controller.TestController#test的方法上打上断点，查看调用栈如下 从中间一段调用栈看出主要经过 HttpServlet 、 FrameworkServlet 、 DispatcherServlet 这几个类的方法，我们从搞清楚这几个类的"
sourcePath: "Java/Framework/SpringMVC/源码分析.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-02-24T11:35:22Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
由图可以看出这几类都是servlet，我们记得servlet的生命周期[Servlet.md](/notes/java/Web/Servlet/Servlet/)
