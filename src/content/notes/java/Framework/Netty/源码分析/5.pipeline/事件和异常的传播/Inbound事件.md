---
title: "2.81 Inbound事件"
description: "1. 添加handler以备实验 我们添加三个InboundHandler进行试验 - InboundHandlerA - InboundHandlerB、C都一样 - NettyServer 2. 从pipeline开始调用 但我们使用ctx.pipeline().fireChannelRead("
sourcePath: "Java/Framework/Netty/源码分析/5.pipeline/事件和异常的传播/Inbound事件.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T09:54:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
