---
title: "2.88 Outbound事件"
description: "1. 添加handler以便实验 - OutboundHandlerA、OutboundHandlerC - OutboundHandlerB - NettyServer 1.1. 使用nc连接 1.2. 输出结果 1.3. 解释 可以看出是从尾巴往头部调用我们的handler 2. 从pipeli"
sourcePath: "Java/Framework/Netty/源码分析/5.pipeline/事件和异常的传播/Outbound事件.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T09:54:28Z"
status: "historical"
language: "zh"
featured: false
indexable: true
