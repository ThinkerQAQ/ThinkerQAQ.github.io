---
title: "2.70 创建NioEventLoop数组"
description: "1. 要分析的代码 2. 传入NioEventLoop构造的参数 我们接着看 newChild(executor, args) ，跳转到 - NioEventLoopGroup#newChild 调用构造方法传入的参数 - this是NioEventLoopGroup自己 - executor是刚刚"
sourcePath: "Java/Framework/Netty/源码分析/1.创建NioEventLoopGroup/创建NioEventLoop数组.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-02-17T13:01:49Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
- executor是刚刚创建的ThreadPerTaskExecutor，说明所有NioEventLoop共享是同一个线程池
