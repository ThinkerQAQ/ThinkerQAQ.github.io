---
title: "2.86 2.初始化channel"
description: "1. 要分析的代码 2. 获取channel pipeline并加入一个ChannelInitializer 如上的代码最关键的在于获取当前channel对应的pipeline，并加入了一个ChannelInitializer。 而在这个ChannelInitializer中，把我们自己在 Serv"
sourcePath: "Java/Framework/Netty/源码分析/3.绑定端口/1.实例化、初始化、并注册channel/2.初始化channel.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T09:52:29Z"
status: "historical"
language: "zh"
featured: false
indexable: true
