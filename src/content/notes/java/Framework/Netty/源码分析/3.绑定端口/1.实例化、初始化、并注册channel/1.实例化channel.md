---
title: "2.79 1.实例化channel"
description: "1. 要分析的代码 2. 反射调用Channel.class的构造方法创建实例 通过反射调用NioServerSocketChannel的构造方法 3. NioServerSocketChannel 3.1. 类体系 3.2. 构造方法 3.2.1. 创建JDK NIO底层的ServerSocket"
sourcePath: "Java/Framework/Netty/源码分析/3.绑定端口/1.实例化、初始化、并注册channel/1.实例化channel.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T11:30:44Z"
status: "historical"
language: "zh"
featured: false
indexable: true
