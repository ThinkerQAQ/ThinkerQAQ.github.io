---
title: "2.84 2.1AnnotationAwareAspectJAutoProxyCreator_Bean实例是如何创建的"
description: "1. 类继承图 如下图可看出AnnotationAwareAspectJAutoProxyCreator既是一个Bean后置处理器，又是一个实现了BeanFactoryAware接口的类 2. 分析调用栈 我们首先再注入的Calc和LogAspects以及上图关键方法打上断点，运行发现调用流程如下 "
sourcePath: "Java/Framework/Spring/Spring_AOP/源码分析/2.AspectJAnnotationAutoProxyCreator组件的功能/2.1AnnotationAwareAspectJAutoProxyCreator_Bean实例是如何创建的.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T13:17:31Z"
status: "historical"
language: "zh"
featured: false
indexable: true
