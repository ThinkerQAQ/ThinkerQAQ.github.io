---
title: "2.96 2.4目标方法是怎么执行的"
description: "1. 继续放行断点执行Calc.div 2. 进入到代理对象的intercept方法 - CglibAopProxy.DynamicAdvisedInterceptor#intercept 2.1. 获取拦截器链 - AdvisedSupport#getInterceptorsAndDynamicI"
sourcePath: "Java/Framework/Spring/Spring_AOP/源码分析/2.AspectJAnnotationAutoProxyCreator组件的功能/2.4目标方法是怎么执行的.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T13:17:50Z"
status: "historical"
language: "zh"
featured: false
indexable: true
