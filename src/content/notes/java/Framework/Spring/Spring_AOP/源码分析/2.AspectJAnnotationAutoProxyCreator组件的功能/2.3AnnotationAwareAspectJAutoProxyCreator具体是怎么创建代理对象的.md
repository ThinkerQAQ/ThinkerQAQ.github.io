---
title: "2.94 2.3AnnotationAwareAspectJAutoProxyCreator具体是怎么创建代理对象的"
description: "1. 跟踪调用栈至postProcessBeforeInstantiation 我们继续放行断点，观察Calc实例的创建，断点主要停留在3个地方 2. 判断是否需要创建代理对象 - org.springframework.aop.framework.autoproxy.AbstractAutoPro"
sourcePath: "Java/Framework/Spring/Spring_AOP/源码分析/2.AspectJAnnotationAutoProxyCreator组件的功能/2.3AnnotationAwareAspectJAutoProxyCreator具体是怎么创建代理对象的.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-01-18T13:17:45Z"
status: "historical"
language: "zh"
featured: false
indexable: true
