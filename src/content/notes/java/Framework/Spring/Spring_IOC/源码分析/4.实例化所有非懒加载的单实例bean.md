---
title: "2.76 4.实例化所有非懒加载的单实例bean"
description: "1. 要研究的代码 - finishBeanFactoryInitialization 这个步骤中尤其重要，他的preInstantiateSingletons会实例化所有非懒加载的单实例bean 2. 实例化所有非懒加载的单实例bean 2.1. 获取所有BeanName，一个个创建 - Defa"
sourcePath: "Java/Framework/Spring/Spring_IOC/源码分析/4.实例化所有非懒加载的单实例bean.md"
category: "java"
categoryLabel: "Java"
topic: "Framework"
...
updatedAt: "2020-02-19T04:34:10Z"
status: "historical"
language: "zh"
featured: false
indexable: true
