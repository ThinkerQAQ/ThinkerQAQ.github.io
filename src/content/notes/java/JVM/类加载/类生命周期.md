---
title: "7.4 类生命周期"
description: "1. 类生命周期 主要有加载、连接、初始化、使用、卸载这几个步骤 1.1. 加载 当我们的代码需要使用一个类的时候，这个类不在JVM中的时候就会加载 1.1.1. 由谁加载 由类加载器负责加载类加载器 1.1.1.1. 类加载器分类 - 启动类加载器负责加载JAVA HOME/lib - 扩展类加载"
sourcePath: "Java/JVM/类加载/类生命周期.md"
category: "java"
categoryLabel: "Java"
topic: "JVM"
topicLabel: "7.JVM"
...
updatedAt: "2020-03-17T07:39:41Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
初始化规则如下：
[类初始化顺序.md](/notes/java/JVM/%E7%B1%BB%E5%8A%A0%E8%BD%BD/%E7%B1%BB%E5%88%9D%E5%A7%8B%E5%8C%96%E9%A1%BA%E5%BA%8F/)
- 例子1
```java
public static int val = 100;
```
...
[垃圾回收.md](/notes/java/JVM/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/)
