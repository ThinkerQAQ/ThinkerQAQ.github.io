---
title: "7.16 对象在内存中的布局"
description: "1. 对象的组成 对象有两种，一个普通对象，另一种数组对象 1.1. 对象头（Object Header） 1. mark word 存储了对象的hashCode、GC信息、锁信息三部分 - 锁信息：不同的状态存储的位的意义不同。跟锁有关的是最后三个bit位，001表示无锁态，00表示轻量级锁，10"
sourcePath: "Java/JVM/类加载/对象在内存中的布局.md"
category: "java"
categoryLabel: "Java"
topic: "JVM"
topicLabel: "7.JVM"
order: 209
tags: ["Java"]
createdAt: "2020-03-15T06:34:59Z"
updatedAt: "2020-03-18T08:52:00Z"
status: "historical"
language: "zh"
featured: false
indexable: true
