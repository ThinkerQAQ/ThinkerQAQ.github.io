---
title: "7.11 自定义类加载器"
description: "1. 什么时候需要自定义类加载器 - 加载任意路径（比如非classpath）下的类文件 - 隔离加载类。这样不同应用的同名类都可以加载，比如tomcat 2. 如何自定义类加载器 1. 继承ClassLoader父类 2. 重写父类的方法 1. 如果走双亲委派机制那么重写 findClass 方法"
sourcePath: "Java/JVM/类加载/自定义类加载器.md"
category: "java"
categoryLabel: "Java"
topic: "JVM"
topicLabel: "7.JVM"
order: 204
tags: ["Java"]
createdAt: "2020-02-12T13:10:44Z"
updatedAt: "2020-02-12T13:35:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
public class MyClassLoader extends ClassLoader
{
    ...
    {
        String path = String.format("C:\\Users\\[user]\\Desktop\\%s.class", name);
        try
        {
