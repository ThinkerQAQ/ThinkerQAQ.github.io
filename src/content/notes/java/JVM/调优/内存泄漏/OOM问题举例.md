---
title: "7.19 OOM问题举例"
description: "1. 为什么会发生OOM 得从GC回收过程说起（参考垃圾回收.md），可以看出GC之回收GCRoot达不到的对象的，GCRoot引用的对象是强引用，是没办法被回收的。 如果jvm内存中都是强引用对象，那么FullGC后jvm内存剩余空间很有可能不足以存放将要创建的新的对象，就会发生OOM 1.1. "
sourcePath: "Java/JVM/调优/内存泄漏/OOM问题举例.md"
category: "java"
categoryLabel: "Java"
topic: "JVM"
topicLabel: "7.JVM"
...
updatedAt: "2020-03-18T11:23:52Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 1. 为什么会发生OOM
得从GC回收过程说起（参考[垃圾回收.md](/notes/java/JVM/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6/)），可以看出GC之回收GCRoot达不到的对象的，GCRoot引用的对象是强引用，是没办法被回收的。
...
[JVM参数调优.md](/notes/java/JVM/%E8%B0%83%E4%BC%98/jvm%E5%8F%82%E6%95%B0/JVM%E5%8F%82%E6%95%B0%E8%B0%83%E4%BC%98/)
