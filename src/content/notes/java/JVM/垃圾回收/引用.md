---
title: "7.17 引用"
description: "1. 强软弱虚引用 1.1. 强 最普遍的引用。一个对象具有强引用，那么绝不会被回收。 - 例子 1.2. 软 内存足够的时候不会被回收，不足的时候会被回收。 使用SoftReference实现，一般用于缓存 - 例子 1.3. 弱 不管内存是否充足，一旦发生gc就会被回收 1.4. 虚 监控GC回"
sourcePath: "Java/JVM/垃圾回收/引用.md"
category: "java"
categoryLabel: "Java"
topic: "JVM"
topicLabel: "7.JVM"
...
updatedAt: "2022-02-26T14:03:03Z"
status: "historical"
language: "zh"
featured: false
indexable: true
