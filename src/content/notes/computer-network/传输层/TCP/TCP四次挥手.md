---
title: "1.2 TCP四次挥手"
description: "1. 什么是四次挥手 所谓四次挥手，是指TCP断开连接时需要发送四个包 2. 四次挥手过程 最开始客户端服务端都处于ESTABLISHED的状态，假设由客户端开始关闭连接 记忆思路：置FIN/ACK为1，FIN伴随着SEQ Number，ACK伴随着ACK Number。发送完会进入什么状态 1. "
sourcePath: "Computer_Network/传输层/TCP/TCP四次挥手.md"
...
updatedAt: "2022-02-27T05:44:47Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 4. 挥手状态
### 4.1. TIME WAIT
TCP time wait.md（关联笔记尚未公开）


### 4.2. CLOSE WAIT
[TCP close wait.md](/notes/computer-network/%E4%BC%A0%E8%BE%93%E5%B1%82/TCP/TCP%20close%20wait/)
