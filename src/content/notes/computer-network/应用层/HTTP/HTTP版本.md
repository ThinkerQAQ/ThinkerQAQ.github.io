---
title: "2.1 HTTP版本"
description: "1. HTTP1.0 1.1. 客户端/服务器 1.2. 短链接 - 每次HTTP请求时建立TCP连接、请求完释放TCP连接，以尽快将资源释放出来服务其他客户端 - 问题：对于图片这种静态资源每张都需要请求服务器，重新建立连接的时间很浪费 - 解决： Connection：Keep-Alive 。即"
sourcePath: "Computer_Network/应用层/HTTP/HTTP版本.md"
category: "computer-network"
categoryLabel: "计算机网络"
topic: "http"
topicLabel: "2.HTTP 与 WebSocket"
order: 8
tags: ["Computer_Network"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2025-10-19T03:47:14Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
- 问题：我们有这样的需求，需要知道多个请求是否由同一个用户发出的
    - 解决：cookie和session.md（关联笔记尚未公开）。但是每次请求都得带上重复的数据，所以性能降低
...
- 连接池：HTTP长链接才有连接池http.md（关联笔记尚未公开）
### 2.2. Pipeline
