---
title: "1.10 Redis信号处理"
description: "1. 处理SIGTERM和SIGINT 告知redis优雅的关闭 - 如果有后台子进程在保存RDB或者执行AOF重写，那么kill掉这个子进程 - 如果AOF开启了，那么对AOF的文件描述符调用fsync以刷新磁盘buffer - 如果RDB开启了，那么按同步阻塞的方式保存RDB。 - 如果RDB无"
sourcePath: "Redis/Redis信号处理.md"
...
order: 10
tags: ["Redis"]
createdAt: "2021-06-05T14:54:46Z"
updatedAt: "2021-06-05T14:54:46Z"
status: "historical"
language: "zh"
featured: false
indexable: true
