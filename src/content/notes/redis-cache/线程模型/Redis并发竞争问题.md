---
title: "3.2 Redis并发竞争问题"
description: "1. 并发竞争问题是什么 假设price初始值为10，有两个连接需要对其执行+10操作，正确的结果应该是30 1. 连接1读取price为10 2. 连接2读取price为10 3. 连接1对price+10为20，写回 4. 连接2对price+10为20，写回 如上，最后的结果为20而不是30，"
sourcePath: "Redis/线程模型/Redis并发竞争问题.md"
...
updatedAt: "2021-06-05T12:41:59Z"
status: "historical"
language: "zh"
featured: false
indexable: true
