---
title: "3.1 Redis线程模型"
description: "1. Redis的Reactor模型 - 由四部分组成：多个socket、IO多路复用、文件事件分派器、事件处理器。 - 其中文件事件分派器消费队列是单线程的，所以Redis才叫单线程模型 - redis server打开了一个server socket监听客户端链接，并把这个socket注册到IO"
sourcePath: "Redis/线程模型/Redis线程模型.md"
...
updatedAt: "2022-06-28T13:30:17Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
### 2.3. 单线程的缺点
- 这个线程一旦[阻塞](/notes/redis-cache/%E7%BA%BF%E7%A8%8B%E6%A8%A1%E5%9E%8B/Redis%E9%98%BB%E5%A1%9E/)，那么Redis就会无法响应
