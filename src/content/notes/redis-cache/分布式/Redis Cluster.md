...
description: "1. 为什么需要redis cluster - 分布式系统分区.md 2. 什么是redis cluster - Redis的分布式方案，解决了主从复制写能力受到单机限制的问题和无法自动进行故障转移的问题 3. 如何搭建redis cluster 集群中可以有多个master，每个master可以由"
sourcePath: "Redis/分布式/Redis Cluster.md"
...
order: 26
tags: ["Redis"]
createdAt: "2020-03-26T06:04:52Z"
updatedAt: "2022-05-05T15:37:22Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
#### 4.2.1. Leader选举
同[Redis Replication.md](/notes/redis-cache/%E5%88%86%E5%B8%83%E5%BC%8F/Redis%20Replication/)
#### 4.2.2. 请求处理
同[Redis Replication.md](/notes/redis-cache/%E5%88%86%E5%B8%83%E5%BC%8F/Redis%20Replication/)
#### 4.2.3. 故障处理
##### 4.2.3.1. 故障检测
...
```redis
[已脱敏内网地址]:6379> CLUSTER KEYSLOT {user1}:myset
(integer) 8106
[已脱敏内网地址]:6379> CLUSTER KEYSLOT {user1}:myset2
(integer) 8106

[已脱敏内网地址]:6379> SUNION {user1}:myset {user1}:myset2
