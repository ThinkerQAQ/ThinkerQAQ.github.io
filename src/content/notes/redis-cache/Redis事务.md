---
title: "1.4 Redis事务"
description: "1. Redis事务是什么 - 一步执行一组命令，有两点保证： - 事务中的所有指令是顺序执行的。也就是说执行这一组指令的过程中，其他客户端看不到中间状态 - 原子性。即所有命令要么都会执行，要么都不被执行。但是 如果中途有一个命令执行失败了，那么之前执行的命令不会回滚 2. Redis事务使用 2"
sourcePath: "Redis/Redis事务.md"
...
order: 4
tags: ["Redis"]
createdAt: "2020-01-28T13:51:45Z"
updatedAt: "2022-03-24T12:17:11Z"
status: "historical"
language: "zh"
featured: false
indexable: true
