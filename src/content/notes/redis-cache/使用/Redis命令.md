---
title: "2.7 Redis命令"
description: "1. Redis通用命令 - keys pattern 查询相应的key - 在redis里,允许模糊查询key，有3个通配符 , ? ,[] - : 通配任意多个字符 - ?: 通配单个字符 - []: 通配括号内的某1个字符 - redis-cli只能查出本节点的数据 - SCAN cursor"
sourcePath: "Redis/使用/Redis命令.md"
...
order: 19
tags: ["Redis"]
createdAt: "2021-06-06T04:08:14Z"
updatedAt: "2021-06-06T04:20:49Z"
status: "historical"
language: "zh"
featured: false
indexable: true
