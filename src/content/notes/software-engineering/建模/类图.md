---
title: "3.3 类图"
description: "1. 是什么 描述系统中的Class的属性和方法，以及Class之间的关系 2. 使用 2.1. 类和接口 + 表示public - 表示private 2.2. 类之间的关系 2.2.1. 泛化、实现 符号：三角形 泛化指extends一个类。 实线 实现指implement一个接口。虚线 2.2"
sourcePath: "Software_Engineering/建模/类图.md"
...
createdAt: "2021-01-03T03:34:33Z"
updatedAt: "2022-02-26T14:14:55Z"
status: "historical"
language: "zh"
featured: false
indexable: true
