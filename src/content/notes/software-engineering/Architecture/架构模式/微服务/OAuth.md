---
title: "2.3 OAuth"
description: "1. OAuth是什么 - 一种授权协议 - 用来授权第三方应用，获取用户数据。 2. 为什么需要OAuth - 以使用微博登录简书，简书需要用到微博的头像昵称 - 传统的作法是输入微博的用户名+密码获取，这种有几个问题 - 微博用户名密码暴露给了简书，可能会泄露 - 只想获取微博头像昵称，但是简书"
sourcePath: "Software_Engineering/Architecture/架构模式/微服务/OAuth.md"
...
createdAt: "2020-06-16T15:11:15Z"
updatedAt: "2023-02-05T08:25:09Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 这是一篇早期 OAuth 2.0 学习笔记。文中的 Implicit 与 Resource Owner Password Credentials 属于历史流程，不应直接作为现代客户端的新方案；实际选型应以当前 OAuth 安全最佳实践与客户端类型为准。
