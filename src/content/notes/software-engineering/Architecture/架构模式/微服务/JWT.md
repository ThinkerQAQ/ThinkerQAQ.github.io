---
title: "2.2 JWT"
description: "1. JWT是什么 - 用户认证成功后，服务器给用户发放的一种token - token是一定时间内有效的令牌，表明用户已经认证 2. 为什么需要JWT - 用于跨域认证 - 所谓跨域认证：指如果一个公司有两个域名A和B，那么用户在A域名认证后，访问B域名不用再次认证了 - 传统的跨域认证是cook"
sourcePath: "Software_Engineering/Architecture/架构模式/微服务/JWT.md"
...
createdAt: "2020-07-26T10:40:52Z"
updatedAt: "2022-03-04T07:36:24Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 这是一篇早期 JWT 学习笔记。JWT 是一种令牌格式，本身不等于认证或会话方案；Payload 默认只是编码而不是加密，不应放入敏感信息。具体登录态、吊销与密钥管理仍需由系统设计解决。
