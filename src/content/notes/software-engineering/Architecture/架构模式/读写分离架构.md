---
title: "1.5 读写分离架构"
description: "1. 什么是读写分离 把读操作（R）和写操作（CUD）分开，本质上就是分布式系统复制中的Leader-Follower模式 2. 为什么需要读写分离 提高读吞吐量 3. 读写分离适用场景 读多写少且允许数据不一致 4. 如何设计读写分离 4.1. 服务层读写分离 优点：代码易维护且没有数据一致性问题"
sourcePath: "Software_Engineering/Architecture/架构模式/读写分离架构.md"
...
createdAt: "2022-03-11T08:24:47Z"
updatedAt: "2022-03-23T05:19:29Z"
status: "historical"
language: "zh"
featured: false
indexable: true
---
## 1. 什么是读写分离
把读操作（R）和写操作（CUD）分开，本质上就是[分布式系统复制](/notes/distributed-systems/%E5%88%86%E5%B8%83%E5%BC%8F%E7%B3%BB%E7%BB%9F%E5%A4%8D%E5%88%B6/%E5%88%86%E5%B8%83%E5%BC%8F%E7%B3%BB%E7%BB%9F%E5%A4%8D%E5%88%B6/)中的Leader-Follower模式
## 2. 为什么需要读写分离
提高读吞吐量
## 3. 读写分离适用场景
读多写少且允许数据不一致
