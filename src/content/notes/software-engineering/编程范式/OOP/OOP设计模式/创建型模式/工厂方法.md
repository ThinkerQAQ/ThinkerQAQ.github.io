---
title: "6.5 工厂方法"
description: "相对于简单工厂有多个工厂类。我们可以传递具体工厂实例而不是具体的产品到子类中，当需要的时候再调用工厂实例的创建产品方法（等于把创建实例对象的时机延迟到子类中） 1. uml 2. Java 2.1. client 2.2. 工厂 2.3. 产品 3. Golang 3.1. 工厂 3.2. 产品 3"
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/创建型模式/工厂方法.md"
...
updatedAt: "2020-04-22T12:32:06Z"
status: "historical"
language: "zh"
featured: false
indexable: true
