---
title: "6.7 构建者模式"
description: "用于构建一个对象,这个对象由许多小对象组成,且流程复杂.如各种Builder. builder负责构建,director负责组装 1. uml 2. Java 2.1. client 2.2. 产品 2.3. 构造者 2.4. 装配者 3. Golang 3.1. client 3.2. 产品 3."
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/创建型模式/构建者模式.md"
...
updatedAt: "2021-05-10T14:17:08Z"
status: "historical"
language: "zh"
featured: false
indexable: true
