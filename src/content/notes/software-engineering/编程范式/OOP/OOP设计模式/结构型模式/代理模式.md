---
title: "6.3 代理模式"
description: "1. 定义 不改变原有代码的基础上为类或者函数增加新功能。 我不想做跟我业务无关的东西 2. uml 3. Java 3.1. 静态代理 代理类在编译时生成，需要程序员自己手写 3.1.1. client 3.1.2. 代理 3.1.3. 被代理 3.2. 动态代理 代理类在运行时生成， 利用的ja"
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/结构型模式/代理模式.md"
...
updatedAt: "2022-05-15T03:06:42Z"
status: "historical"
language: "zh"
featured: false
indexable: true
