---
title: "6.4 模板方法"
description: "1. 定义 适用于某个算法整体步骤固定,某些部分易变化.可以把变化的部分抽象出来.如servlet的doGet()和doPost()方法 2. uml 3. Java 3.1. client 3.2. 固定步骤 4. Golang 4.1. 第一种 4.1.1. client 4.1.2. 模板方法"
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/行为型模式/模板方法.md"
...
updatedAt: "2021-05-13T15:01:39Z"
status: "historical"
language: "zh"
featured: false
indexable: true
