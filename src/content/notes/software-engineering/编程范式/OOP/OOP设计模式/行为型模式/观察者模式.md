---
title: "6.9 观察者模式"
description: "1. 定义 - 某个对象状态更新,需要通知给所有对象:广播 - 由两个角色：目标、观察者 - 观察者观察目标（监听目标） - 目标发生变化 - 目标主动通知观察者。 2. UML 3. Java 3.1. client 3.2. 被观察的对象 3.3. 观察者 4. Golang 4.1. 主题 4"
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/行为型模式/观察者模式.md"
...
updatedAt: "2021-05-29T03:03:01Z"
status: "historical"
language: "zh"
featured: false
indexable: true
