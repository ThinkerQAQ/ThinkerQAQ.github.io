---
title: "6.11 责任链"
description: "1. 定义 能处理同一类请求的对象连成一条链,servlet filter 2. uml 3. Java 3.1. client 3.2. 处理链 3.3. 请求 4. Golang 4.1. client 4.2. 处理链 4.3. 请求 5. 实例 5.1. 过滤器链 6. 参考 - niedb"
sourcePath: "Software_Engineering/编程范式/OOP/OOP设计模式/行为型模式/责任链.md"
...
updatedAt: "2021-06-03T14:37:04Z"
status: "historical"
language: "zh"
featured: false
indexable: true
