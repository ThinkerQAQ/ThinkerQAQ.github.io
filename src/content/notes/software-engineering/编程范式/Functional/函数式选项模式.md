---
title: "4.1 函数式选项模式"
description: "1. 定义 - 创建由默认值的对象，同时可以灵活地修改属性 - 我们可能需要为Option的字段指定默认值 - Option的字段成员可能会发生变更 2. Golang 2.1. 要创建的对象 2.2. 测试 3. 参考 - Go语言设计模式之函数式选项模式 \\ 李文周的博客"
sourcePath: "Software_Engineering/编程范式/Functional/函数式选项模式.md"
...
createdAt: "2020-10-02T08:26:23Z"
updatedAt: "2020-10-02T08:30:03Z"
status: "historical"
language: "zh"
featured: false
indexable: true
