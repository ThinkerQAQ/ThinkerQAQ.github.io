---
title: "2.11 BitMap"
description: "1. BitMap是什么 - 又叫位图 - 把数据存放在一个以bit为单位的数据结构里，每位都只有0和1两个值。为0的时候，证明值不存在；为1的时候说明存在。 1.1. 举例 这个时候假如我们要存放2 4 6 8 9 10 17 19 21这些数字到我们的BitMap里，我们只需把对应的位设置为1就"
sourcePath: "Algorithm/数据结构/BitMap.md"
category: "algorithm"
...
order: 12
tags: ["Algorithm"]
createdAt: "2020-03-21T12:57:40Z"
updatedAt: "2021-06-28T15:29:13Z"
status: "historical"
language: "zh"
featured: false
indexable: true
