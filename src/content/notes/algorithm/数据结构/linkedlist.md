---
title: "2.3 linkedlist"
description: "1. 是什么 2. 数组 vs 链表 数组按照索引查找快，链表插入删除快 3. 单向链表 3.1. 数据结构 - 头节点 - 长度 3.2. API 3.3. 实现 3.3.1. 测试 4. 双向链表 4.1. 数据结构 - 头节点 - 尾节点 - 长度 4.2. API - 同单向链表 4.3. "
sourcePath: "Algorithm/数据结构/linkedlist.md"
category: "algorithm"
...
order: 4
tags: ["Algorithm"]
createdAt: "2021-01-10T06:03:25Z"
updatedAt: "2022-06-18T07:31:17Z"
status: "historical"
language: "zh"
featured: false
indexable: true
