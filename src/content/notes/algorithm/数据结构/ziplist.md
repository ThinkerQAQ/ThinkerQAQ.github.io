---
title: "2.16 ziplist"
description: "1. 什么是ziplist - Redis底层的一种数据结构，用于实现list、zset

> 2026 注：这是旧版 Redis 的实现背景；现代 Redis 已不再以 ziplist 作为这些结构的主要编码。 - 一段连续的内存空间 2. 为什么需要ziplist - 动态数组：由长度+元素列表组成。每个元素占用的空间大小相同，类型也是相同的 - - ziplist：也由长度+元素列表组成。不同之处在于 - 每个元素"
sourcePath: "Algorithm/数据结构/ziplist.md"
category: "algorithm"
...
order: 17
tags: ["Algorithm"]
createdAt: "2021-05-23T12:46:58Z"
updatedAt: "2022-08-27T05:08:20Z"
status: "historical"
language: "zh"
featured: false
indexable: true
