---
title: "2.1 array"
description: "1. 是什么 - 可动态扩容的数组 2. 动态数组 2.1. 数据结构 - 存放数据的数组 - 已使用的长度 - 总长度 2.2. API 2.3. 实现 2.3.1. 测试 3. 刷题套路 3.1. 双指针 3.1.1. 同向 - - [0, i) 是处理好的数据， [i, j) 是处理过但不需要"
sourcePath: "Algorithm/数据结构/array.md"
category: "algorithm"
...
order: 2
tags: ["Algorithm"]
createdAt: "2021-01-10T05:49:46Z"
updatedAt: "2021-02-12T12:58:55Z"
status: "historical"
language: "zh"
featured: false
indexable: true
