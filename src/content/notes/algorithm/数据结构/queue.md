---
title: "2.4 queue"
description: "1. 是什么 - 先进先出 2. 普通队列 2.1. 数据结构 - 动态数组或链表 2.2. API 2.3. 实现 2.3.1. 测试 3. 循环队列 3.1. 数据结构 - 存放数据的数组 - 已使用的长度 - 总长度 - 头节点下标位置 - 尾节点下标位置 3.2. API - 同队列 3.3"
sourcePath: "Algorithm/数据结构/queue.md"
category: "algorithm"
...
order: 5
tags: ["Algorithm"]
createdAt: "2021-01-10T06:13:41Z"
updatedAt: "2022-07-21T13:41:26Z"
status: "historical"
language: "zh"
featured: false
indexable: true
