---
title: "3.13 插入排序"
description: "1. 插入排序 把数组分成有序和无序的部分，从无序部分取出每一个元素插入到已排好序的数组中 在数组相对有序的情况下效率比选择排序高，时间复杂度O（N） 2. 特点 - 稳定性：稳定 - 原地排序 - 空间复杂度：O（1） - 时间复杂度：O（n²） 3. 过程 4. 实现 4.1. 测试 5. 参考"
sourcePath: "Algorithm/算法/排序/插入排序.md"
category: "algorithm"
...
order: 34
tags: ["Algorithm"]
createdAt: "2020-02-29T11:06:43Z"
updatedAt: "2021-03-28T06:07:27Z"
status: "historical"
language: "zh"
featured: false
indexable: true
