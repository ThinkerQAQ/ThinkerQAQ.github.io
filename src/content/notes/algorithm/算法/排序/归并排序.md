---
title: "3.12 归并排序"
description: "1. 归并排序 采用了分而治之的思想，就是说把一个大的问题分成小的问题，然后递归求解 不停地把数组拆成两半，直到有序（只有一个节点），最后进行合并 如果说快速排序的关键在于分，那么归并排序的关键在于合 2. 特点 - 稳定性：稳定 - 原地排序：不是 - 复杂度 - 时间：O（nlogn） - - "
sourcePath: "Algorithm/算法/排序/归并排序.md"
category: "algorithm"
...
order: 33
tags: ["Algorithm"]
createdAt: "2020-02-29T09:40:18Z"
updatedAt: "2024-02-26T14:23:48Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 2026 注：对这里给出的标准归并排序实现，即使输入已有序，时间复杂度仍是 O(NlogN)。
    - 空间：O（n）
