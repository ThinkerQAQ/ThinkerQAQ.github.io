---
title: "3.5 递归"
description: "1. 递归是什么 - 函数自己调用自己 2. 递归的调用过程 - 以求和函数为例 - 测试 - 过程分析 3. 递归基本思想 1. 拆解问题 1. 把规模大的问题拆成规模较小的问题 2. 规模较小的问题拆成规模更小的问题 3. 规模小到一定程度可以直接得出答案 2. 求解 1. 由最小规模问题的解得"
sourcePath: "Algorithm/算法/递归.md"
category: "algorithm"
...
order: 26
tags: ["Algorithm"]
createdAt: "2021-02-18T09:12:46Z"
updatedAt: "2021-02-18T12:45:31Z"
status: "historical"
language: "zh"
featured: false
indexable: true
