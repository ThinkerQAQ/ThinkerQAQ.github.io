---
title: "3.7 DFS"
description: "1. DFS是什么 - 深度优先搜索，适用于字符串、数组、树，经常配合回溯.md使用 2. 字符串 2.1. 全排列 - 输入一个字符串，输出它的全排列 - 分析：使用树 - 2.1.1. 经典做法 2.1.2. 升级版 2.2. 组合 - 子集.md 3. 数组 3.1. 组合总和 - 组合总和."
sourcePath: "Algorithm/算法/DFS.md"
category: "algorithm"
...
order: 28
tags: ["Algorithm"]
createdAt: "2021-03-08T14:42:46Z"
updatedAt: "2022-07-16T13:58:39Z"
status: "historical"
language: "zh"
featured: false
indexable: true
---
## 1. DFS是什么
- 深度优先搜索，适用于字符串、数组、树，经常配合[回溯.md](/notes/algorithm/%E7%AE%97%E6%B3%95/%E5%9B%9E%E6%BA%AF/)使用
