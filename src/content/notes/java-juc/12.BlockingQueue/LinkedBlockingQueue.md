---
title: "12.2 LinkedBlockingQueue"
description: "1. 是什么 使用单向链表实现的有界的阻塞队列 读读、写写相互阻塞，读写不相互阻塞 吞吐量比ArrayBlockingQueue高 2. 如何使用 3. 源码分析 3.1. 构造方法 3.1.1. 底层使用单向链表+Lock+Condition实现 3.1.2. Node 结构如下图： 3.2. p"
sourcePath: "Java/JUC/12.BlockingQueue/LinkedBlockingQueue.md"
category: "java-juc"
...
updatedAt: "2020-01-18T06:30:12Z"
status: "historical"
language: "zh"
featured: false
indexable: true
