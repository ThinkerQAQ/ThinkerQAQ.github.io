---
title: "13.ThreadLocal"
description: "1. 是什么 不是线程同步机制，是一种线程数据隔离机制。 多线程共享变量通信的情况下，我们需要保证线程安全。一种方法是使用锁，另一种就是数据隔离机制。 ThreadLocal用的是后一种，即每个线程操作的是自己独有的数据，因此互相之间不会影响 2. 如何使用 3. 原理分析 3.1. uml Thr"
sourcePath: "Java/JUC/13.ThreadLocal/13.ThreadLocal.md"
category: "java-juc"
categoryLabel: "Java / JUC"
topic: "13.ThreadLocal"
topicLabel: "13.ThreadLocal"
order: 23
tags: ["Java","JUC"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2020-02-09T04:58:08Z"
status: "historical"
language: "zh"
featured: false
indexable: true
