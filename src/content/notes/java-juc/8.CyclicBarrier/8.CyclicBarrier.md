---
title: "8.CyclicBarrier"
description: "1. 是什么 可重复使用的计数器，让一堆线程互相等待，条件满足时一起往下执行 底层使用Lock+Condition实现阻塞等待和唤醒 2. 如何使用 2.1. 不带Runnable 当所有线程都到达await点的时候才一起往下执行 2.2. 带Runnale 当所有线程都到达await点的时候，最后"
sourcePath: "Java/JUC/8.CyclicBarrier/8.CyclicBarrier.md"
category: "java-juc"
categoryLabel: "Java / JUC"
topic: "8.CyclicBarrier"
topicLabel: "8.CyclicBarrier"
order: 14
tags: ["Java","JUC"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2020-02-17T08:33:16Z"
status: "historical"
language: "zh"
featured: false
indexable: true
