---
title: "6.1 公平锁"
description: "所谓公平锁，遵循先到先得的原则。 即使锁已经被释放了，后到的也不能去抢占锁，得等到前面没人时才能去获取 1. 如何使用 2. 原理分析 2.1. 构造方法 2.1.1. 底层使用AQS实现 2.2. 加锁 - lock 2.2.1. 调用公平锁的lock方法 - FairSync.lock 2.2."
sourcePath: "Java/JUC/6.ReentrantLock/公平锁.md"
category: "java-juc"
...
updatedAt: "2020-01-18T06:28:03Z"
status: "historical"
language: "zh"
featured: false
indexable: true
