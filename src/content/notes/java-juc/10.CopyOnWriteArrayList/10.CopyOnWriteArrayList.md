---
title: "10.CopyOnWriteArrayList"
description: "1. 是什么 这个list借鉴的是读写分离的思想（弱一致性） - 读的时候可以并发读，不加锁； - 写的时候需要加锁，复制一份原有数据进行修改，改完后写回list 2. 如何使用 3. 原理 3.1. 构造方法 - 可以看到底层是通过object数组实现, - 通过 getArray/setArra"
sourcePath: "Java/JUC/10.CopyOnWriteArrayList/10.CopyOnWriteArrayList.md"
category: "java-juc"
categoryLabel: "Java / JUC"
topic: "10.CopyOnWriteArrayList"
topicLabel: "10.CopyOnWriteArrayList"
order: 16
tags: ["Java","JUC"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2020-02-11T13:27:02Z"
status: "historical"
language: "zh"
featured: false
indexable: true
