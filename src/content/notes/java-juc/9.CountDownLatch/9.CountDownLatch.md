...
description: "1. 是什么 不能重复使用的计数器。让一个线程等待其他线程完事再往下执行，类似于Thread.join() 底层使用AQS实现 2. 如何使用 - 注意 这里countdown的线程不会互相等待，谁先执行完谁就先退出 2.1. CountDownLatch VS CyclicBarrier Coun"
sourcePath: "Java/JUC/9.CountDownLatch/9.CountDownLatch.md"
category: "java-juc"
categoryLabel: "Java / JUC"
topic: "9.CountDownLatch"
topicLabel: "9.CountDownLatch"
order: 15
tags: ["Java","JUC"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2020-01-18T06:28:49Z"
status: "historical"
language: "zh"
featured: false
indexable: true
