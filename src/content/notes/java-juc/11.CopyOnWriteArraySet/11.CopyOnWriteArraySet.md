---
title: "11.CopyOnWriteArraySet"
description: "1. 是什么 写时复制的set，有序不重复，底层使用CopyOnWriteArrayList实现 2. 如何使用 3. 原理分析 3.1. 构造方法 3.1.1. 底层使用CopyOnWriteArrayList实现 3.2. add方法 3.2.1. 转调CopyOnWriteArrayList "
sourcePath: "Java/JUC/11.CopyOnWriteArraySet/11.CopyOnWriteArraySet.md"
category: "java-juc"
categoryLabel: "Java / JUC"
topic: "11.CopyOnWriteArraySet"
topicLabel: "11.CopyOnWriteArraySet"
order: 17
tags: ["Java","JUC"]
createdAt: "2020-01-17T13:06:57Z"
updatedAt: "2020-01-18T06:29:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
大体逻辑跟[10.CopyOnWriteArrayList.md的remove方法](/notes/java-juc/10.CopyOnWriteArrayList/10.CopyOnWriteArrayList/)差不多
...
##### 3.4.1.2. 存在的话再去删除
参考[10.CopyOnWriteArrayList.md remove方法](/notes/java-juc/10.CopyOnWriteArrayList/10.CopyOnWriteArrayList/) 
