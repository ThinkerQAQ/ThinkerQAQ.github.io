---
title: "1.3 如何实现分布式ID"
description: "1. 分布式ID是什么 分布式环境（多台机器）下唯一的ID 分布式ID的特性 - 全局唯一 - ID嘛，当然得保证唯一性 - 趋势递增 - 递增是为了适应MySQL InnoDB存储引擎聚簇索引的特点 - 趋势而不是顺序是为了防止认为猜测到ID生成策略从而进行攻击 可以加个时间戳 - 高并发 - 淘"
sourcePath: "System_Design/分布式系统/如何实现分布式ID.md"
...
updatedAt: "2022-06-05T12:52:41Z"
status: "historical"
language: "zh"
featured: false
indexable: true
