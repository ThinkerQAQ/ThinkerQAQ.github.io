---
title: "2.3 分布式事务方案之可靠消息最终一致性"
description: "1. 可靠消息最终一致性是什么 保证最终一致性的一种分布式事务方案 2. 可靠消息最终一致性流程 3. 可靠消息最终一致性的使用场景 - 适用于一些最终一致性、时间敏感度低、分布式事务只能成功不能失败的业务，比如注册送积分，登录送优惠券等 - 多个服务多个数据源且数据源可以不是DB 4. 可靠消息最"
sourcePath: "System_Design/分布式系统/分布式事务/分布式事务方案之可靠消息最终一致性.md"
...
createdAt: "2021-06-01T02:58:42Z"
updatedAt: "2022-03-03T13:07:21Z"
status: "historical"
language: "zh"
featured: false
indexable: true
