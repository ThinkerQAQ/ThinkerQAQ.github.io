---
title: "2.1 分布式事务方案之2PC"
description: "1. 2PC是什么 保证强一致性的一种分布式事务方案 2. 2PC流程 - 把事务分成两个阶段 - 第一阶段：由事务管理器向所有database发送prepare请求 - 第二阶段根据第一阶段的结果决定。 - 如果第一阶段全部响应ok那么执行第二阶段的commit； - 如果第一阶段有一个datab"
sourcePath: "System_Design/分布式系统/分布式事务/分布式事务方案之2PC.md"
...
updatedAt: "2022-03-03T13:04:54Z"
status: "historical"
language: "zh"
featured: false
indexable: true
