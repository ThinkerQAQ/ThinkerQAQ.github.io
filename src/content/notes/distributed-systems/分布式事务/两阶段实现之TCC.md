---
title: "2.10 两阶段实现之TCC"
description: "1. TCC是什么 - 2PC是数据库层面的两阶段，而TCC是应用层面的两阶段 - TCC： - Try：尝试执行事务 - Confirm：确认执行事务 - Cancel：取消执行事务 - 本质上也是属于两阶段事务。 - 第一阶段执行Try操作，对业务检查及资源预留 - 第二阶段根据第一阶段的结果决"
sourcePath: "System_Design/分布式系统/分布式事务/两阶段实现之TCC.md"
...
updatedAt: "2021-06-01T09:09:29.634Z"
status: "historical"
language: "zh"
featured: false
indexable: true
