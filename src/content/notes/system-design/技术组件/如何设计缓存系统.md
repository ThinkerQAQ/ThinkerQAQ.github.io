---
title: "2.9 如何设计缓存系统"
description: "1. 什么是缓存 CPU和磁盘的速度差异巨大，一般会根据局部性原理把常用的数据加载到内存中，以提高访问速度 2. 为什么需要缓存 - 提高性能 - 降低下游负载 3. 缓存的缺点 3.1. 缓存一致性 - CAP原则下延迟导致的一致性是没办法解决的，只能保证最终一致性 - 如果是read-throu"
sourcePath: "System_Design/技术组件/如何设计缓存系统.md"
...
order: 17
tags: ["System_Design"]
createdAt: "2022-07-15T14:06:19Z"
updatedAt: "2022-07-15T14:06:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
#### 5.7.5. CDC
- 变更数据捕获系统
- 比如Linkedin的databus、阿里巴巴的canal（关联笔记尚未公开）
#### 5.7.6. 方案对比
- refresh-ahead：
...
- 比如Golang的sync.singleflight.md（关联笔记尚未公开）
...
## 6. 如何设计缓存中间件
- [如何设计一个缓存中间件.md](/notes/system-design/%E6%8A%80%E6%9C%AF%E7%BB%84%E4%BB%B6/%E5%A6%82%E4%BD%95%E8%AE%BE%E8%AE%A1%E4%B8%80%E4%B8%AA%E7%BC%93%E5%AD%98%E4%B8%AD%E9%97%B4%E4%BB%B6/)
## 7. 参考
