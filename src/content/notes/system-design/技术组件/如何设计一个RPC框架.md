---
title: "2.3 如何设计一个RPC框架"
description: "1. 什么是RPC - 远程过程调用 - 是一个计算机通信协议 - 这种协议使得client可以像调用本地函数一样去调用server上的函数，即屏蔽了网络通讯的细节 - 采用C/S模式，经典实现是request-response 1.1. 本地函数调用 vs RPC - 本地函数调用：不需要经过网络"
sourcePath: "System_Design/技术组件/如何设计一个RPC框架.md"
...
order: 11
tags: ["System_Design"]
createdAt: "2021-04-15T14:40:13Z"
updatedAt: "2022-07-05T14:02:52Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
如何设计注册中心.md（关联笔记尚未公开）
#### 4.4.3. 负载均衡
如何设计负载均衡组件.md（关联笔记尚未公开）


### 4.5. 如何优化
#### 4.5.1. 超时重试

[如何设计超时与重试系统.md](/notes/system-design/%E6%8A%80%E6%9C%AF%E7%BB%84%E4%BB%B6/%E5%A6%82%E4%BD%95%E8%AE%BE%E8%AE%A1%E8%B6%85%E6%97%B6%E4%B8%8E%E9%87%8D%E8%AF%95%E7%B3%BB%E7%BB%9F/)
#### 4.5.2. 熔断
如何设计熔断系统.md（关联笔记尚未公开）
#### 4.5.3. 流控
