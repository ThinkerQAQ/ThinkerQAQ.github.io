---
title: "1.3 如何设计高可用系统"
description: "1. 什么是高可用系统 - 即可用性高的系统 - 可用性指的是系统的一部分出现了故障，我们能预料并应对这个故障。本质上就是容错 - 可用性高 - 可用性=平均故障间隔/(平均故障间隔 + 故障恢复平均时间) - 一般都是以几个9来表示系统的可用性，99.99的可用性较多，9越多就代表可用性越强 2."
sourcePath: "System_Design/如何设计高可用系统.md"
...
order: 3
tags: ["System_Design"]
createdAt: "2020-02-23T14:34:04Z"
updatedAt: "2025-07-16T04:51:23Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 1. 什么是高可用系统
- 即可用性高的系统
    - 可用性指的是系统的一部分出现了[故障](/notes/distributed-systems/%E5%88%86%E5%B8%83%E5%BC%8F%E7%B3%BB%E7%BB%9F%E6%95%85%E9%9A%9C/)，我们能预料并应对这个故障。本质上就是容错
    - 可用性高
...
[【IT老齐356】OPPO同城多活、异地双活、异地多活数据架构\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV17N411k7Wr/?spm_id_from=333.337.search-card.all.click&vd_source=79c9f80f56384444d88bfb3e4cf579df)
##### 2.4.3.1. 异地双活
...
### 2.5. 运维阶段
#### 2.5.1. 监控
- 如何设计监控系统.md（关联笔记尚未公开）

#### 2.5.2. 混沌工程
- 如何设计混沌工程.md（关联笔记尚未公开）
#### 2.5.3. 复盘
