---
title: "5.9 火焰图"
description: "1. perf命令 是 Linux 系统原生提供的性能分析工具，会返回 CPU 正在执行的函数名以及调用栈（stack） 1.1. 使用 - perf record表示记录 - -F 99表示每秒99次。如果99次都返回同一个函数名，那就说明 CPU 这一秒钟都在执行同一个函数，可能存在性能问题 -"
sourcePath: "Operating_System/Linux/性能调优/火焰图.md"
...
createdAt: "2021-04-17T12:27:40Z"
updatedAt: "2021-04-18T03:39:41Z"
status: "historical"
language: "zh"
featured: false
indexable: true
