---
title: "5.1 CPU调优"
description: "1. CPU性能指标 1.1. CPU使用率 非空闲时间占总 CPU 时间的百分比。 根据 CPU 上运行任务的不同，又被分为用户 CPU、系统 CPU、等待 I/O CPU、软中断和硬中断等 - 用户CPU：应用程序 - 系统CPU：内核（不包括中断） - 等待IO CPU：系统与硬件设备交互 -"
sourcePath: "Operating_System/Linux/性能调优/CPU调优.md"
...
createdAt: "2021-09-26T03:16:04Z"
updatedAt: "2022-06-03T10:11:06Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
### 3.3. 分析进程
- 如果是Java进程
    1. Java线上问题排查.md（关联笔记尚未公开）
- 如果是Golang进程
    1. [pprof](/notes/go/pprof/)
- 如果是MySQL进程
    1. [MySQL线上问题排查.md](/notes/mysql-database/MySQL%E7%BA%BF%E4%B8%8A%E9%97%AE%E9%A2%98%E6%8E%92%E6%9F%A5/)
