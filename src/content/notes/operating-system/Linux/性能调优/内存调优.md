---
title: "5.3 内存调优"
description: "1. 内存性能指标 1.1. 系统内存使用情况 1.1.1. 已用内存 已经使用的内存 1.1.2. 剩余内存 还未使用的内存 1.1.3. 共享内存 tmpfs使用的内存大小，其实也是一种缓存 1.1.4. 可用内存 剩余内存+缓存和缓冲区 1.1.5. 缓存和缓冲区 缓存分为两部分 - 磁盘读取"
sourcePath: "Operating_System/Linux/性能调优/内存调优.md"
...
createdAt: "2021-09-26T06:15:40Z"
updatedAt: "2022-04-30T15:06:52Z"
status: "historical"
language: "zh"
featured: false
indexable: true
