---
title: "5.7 iostat"
description: "1. 使用 - 默认输出的不是当前IO状态，而是系统启动以来的 2. 输出 - 3. 解释 - avg-cpu - %user：用户模式花费的CPU时间 一般<60% - %nice：用户进程改变过优先级的进程占用的CPU时间 - %system：内核进程所花费的CPU时间。一般sy+us<80% "
sourcePath: "Operating_System/Linux/命令/iostat.md"
...
createdAt: "2021-04-18T09:50:33Z"
updatedAt: "2021-04-18T09:50:36Z"
status: "historical"
language: "zh"
featured: false
indexable: true
