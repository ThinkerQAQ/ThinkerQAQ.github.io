---
title: "4.4 IO"
description: "1. 什么是文件 文件是由字节序列组成的，在Linux下一切皆文件 所有的IO设备都是文件 - /dev/sda2 (/usr disk partition) - /dev/tty2 (terminal) 内核也是文件 - /boot/vmlinuz-3.13.0-55-generic (kerne"
sourcePath: "Operating_System/Linux/IO/IO.md"
...
createdAt: "2020-09-13T11:05:23Z"
updatedAt: "2022-07-17T06:39:11Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 2026 注：这里把系统调用与直接 I/O 混在了一起。普通 `read/write` 默认仍会经过页缓存；Linux 通常通过 `O_DIRECT` 请求绕过页缓存。
