---
title: "4.5 零拷贝机制"
description: "1. 传统IO 正常的数据处理流程是这样的： 1. 使用DMA copy（不需要cpu参与）把磁盘中的数据copy到磁盘缓冲区 2. 使用cpu copy把磁盘缓冲区的数据复制到用户区 3. 用户区进行处理 4. 使用cpu copy把 用户区的数据拷贝到Socket缓冲区 5. 使用DMA cop"
sourcePath: "Operating_System/Linux/IO/零拷贝机制.md"
...
createdAt: "2020-02-05T12:22:07Z"
updatedAt: "2022-02-26T13:57:06Z"
status: "historical"
language: "zh"
featured: false
indexable: true
