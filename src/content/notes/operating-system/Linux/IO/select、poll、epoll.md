---
title: "4.3 select、poll、epoll"
description: "1. select - select的几大缺点： - 每次调用select，都需要把fd集合从用户态拷贝到内核态，这个开销在fd很多时会很大 - 同时每次调用select都需要在内核遍历传递进来的所有fd，这个开销在fd很多时也很大 - select支持的文件描述符数量太小了，默认是1024 - 2"
sourcePath: "Operating_System/Linux/IO/select、poll、epoll.md"
...
updatedAt: "2021-08-14T08:39:15Z"
status: "historical"
language: "zh"
featured: false
indexable: true
