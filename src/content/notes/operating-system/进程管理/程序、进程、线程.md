---
title: "2.7 程序、进程、线程"
description: "1. 是什么 程序是指令的集合，存放在硬盘上，是个静态的实体 进程指程序加载到内存，由CPU执行指令，是个动态的实体 线程是进程内的多个执行流 举例： 比如一个视频播放器，安装完后躺在硬盘上，此时就是一堆指令+数据； 播放一个视频的时候这个程序首先加载到内存中，由CPU读取指令并执行 一个视频既有画"
sourcePath: "Operating_System/进程管理/程序、进程、线程.md"
...
createdAt: "2020-01-31T08:26:13Z"
updatedAt: "2022-03-20T12:29:46Z"
status: "historical"
language: "zh"
featured: false
indexable: true
