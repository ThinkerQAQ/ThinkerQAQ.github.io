---
title: "1.8 MySQL锁"
description: "1. 锁是什么 - 数据库锁.md 2. 锁的实现 - trx信息 ：代表这个锁结构是哪个事务生成的。 - is waiting ：代表当前事务是否在等待 3. 锁的分类 - 根据加锁的范围，MySQL里面的锁大致可以分成全局锁、表级锁和行锁三类 3.1. 全局锁 3.1.1. 是什么 - Flus"
sourcePath: "Database/MySQL/MySQL锁.md"
...
order: 8
tags: ["Database","MySQL"]
createdAt: "2021-05-08T13:12:48Z"
updatedAt: "2022-12-26T03:19:34Z"
status: "historical"
language: "zh"
featured: false
indexable: true
