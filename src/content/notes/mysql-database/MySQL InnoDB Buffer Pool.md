---
title: "1.27 MySQL InnoDB Buffer Pool"
description: "1. Buffer Pool是什么 - MySQL启动时向操作系统申请的连续的内存空间 2. 为什么需要Buffer Pool - 磁盘和CPU的速度差异太大，因此需要内存作为缓存 3. Buffer Pool工作流程 - 读数据时向从Buffer Pool中读，有的话直接返回，没有再去磁盘读，然后"
sourcePath: "Database/MySQL/MySQL InnoDB Buffer Pool.md"
...
order: 27
tags: ["Database","MySQL"]
updatedAt: "2021-05-08T16:03:54.976Z"
status: "historical"
language: "zh"
featured: false
indexable: true
