---
title: "1.4 MySQL安装配置"
description: "1. 安装MySQL步骤 1.1. 安装 1.2. 启动 1.3. 设置root密码 1.4. 创建用户 1.5. 修改监听端口 2. 默认配置 2.1. 打印默认配置信息 2.2. 配置文件位置 2.3. 基础配置 2.3.1. log-bin 主要用于主从复制 2.3.2. log-error "
sourcePath: "Database/MySQL/MySQL安装配置.md"
...
updatedAt: "2022-06-02T14:38:54Z"
status: "historical"
language: "zh"
featured: false
indexable: true
