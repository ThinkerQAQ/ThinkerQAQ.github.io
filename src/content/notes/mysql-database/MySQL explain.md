...
description: "1. 是什么 用来查看MYSQL是怎么执行sql语句的，以便优化sql 2. 作用 - 表的读取顺序 - 哪些索引可以使用 - 实际用到的索引 - 每张表读取了多少行 3. 字段说明 3.1. id - 一个select对应一个id - id相同的情况下由上往下执行 - 连接查询，一个select+"
sourcePath: "Database/MySQL/MySQL explain.md"
...
updatedAt: "2021-05-09T08:53:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
