---
title: "1.18 MySQL表访问方法"
description: "1. 单表访问方法 - MySQL 执行查询语句的方式称之为 访问方法 或者 访问类型 1.1. const 1.1.1. 通过主键或者唯一二级索引与等值比较只匹配1条记录 1.1.1.1. 通过主键与常数的等值比较 - 1.1.1.2. 通过唯一二级索引列与常数的等值比较 - 1.2. ref 1"
sourcePath: "Database/MySQL/MySQL表访问方法.md"
...
order: 18
tags: ["Database","MySQL"]
createdAt: "2021-06-07T12:01:06Z"
updatedAt: "2021-06-07T12:02:13Z"
status: "historical"
language: "zh"
featured: false
indexable: true
