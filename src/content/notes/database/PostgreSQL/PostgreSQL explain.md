---
title: "2.3 PostgreSQL explain"
description: "1. 不加where 1.1. 普通的explain - 结果 1.1.1. 解析 - 读取的方式 - 顺序扫描，一块块读取 - 统计信息 - cost - 获取第一行的时间 - 获取所有行的时间 - 单位是page unit，不是毫秒 - rows - 扫描的行数 - width - 所有行的平均"
sourcePath: "Database/PostgreSQL/PostgreSQL explain.md"
category: "database"
...
updatedAt: "2021-05-09T04:24:54Z"
status: "historical"
language: "zh"
featured: false
indexable: true
