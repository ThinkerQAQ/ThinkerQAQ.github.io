---
title: "1.9 MySQL索引底层实现"
description: "1. 索引底层实现 - 在InnoDB存储引擎中，每一个索引对应一棵B+树 2. 为什么选用B+树 首先我们先思考为什么选用树这种结构，而不是线性表或者链表 2.1. 为什么是树 - 线性表的特点是查找快O（1），但是插入删除效率低O（n） - 链表的特点是插入删除快O（1），查找慢O（n） - h"
sourcePath: "Database/MySQL/MySQL索引底层实现.md"
category: "database"
...
updatedAt: "2022-06-29T14:55:58Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
## 3. InnoDB和MyISAM索引
[InnoDB和MyISAM索引对比.md](/notes/database/MySQL/InnoDB/InnoDB%E5%92%8CMyISAM%E7%B4%A2%E5%BC%95%E5%AF%B9%E6%AF%94/)
## 4. 参考
