...
## 1. InnoDB特点
### 1.1. 支持事务
- [InnoDB事务.md](/notes/database/MySQL/InnoDB/InnoDB%E4%BA%8B%E5%8A%A1/)
### 1.2. 支持行级锁
- [MySQL锁.md](/notes/database/MySQL/MySQL%E9%94%81/)
### 1.3. 支持MVCC
- [InnoDB MVCC.md](/notes/database/MySQL/InnoDB/InnoDB%20MVCC/)
## 2. InnoDB架构
...
- [InnoDB Buffer Pool.md](/notes/database/MySQL/InnoDB/InnoDB%20Buffer%20Pool/)
#### 2.1.2. Change Buffer
...
#### 2.2.1. Tables
- 数据表的物理结构
- [MySQL文件系统.md](/notes/database/MySQL/MySQL%E6%96%87%E4%BB%B6%E7%B3%BB%E7%BB%9F/)
#### 2.2.2. Indexes
- 索引的物理结构
- [MySQL索引.md](/notes/database/MySQL/MySQL%E7%B4%A2%E5%BC%95/)
#### 2.2.3. Tablespaces
- 表空间，数据存储区域
- [InnoDB表空间.md](/notes/database/MySQL/InnoDB/InnoDB%E8%A1%A8%E7%A9%BA%E9%97%B4/)
#### 2.2.4. Redo Log
- 记录DML操作的日志，用来崩溃后的数据恢复
- [InnoDB redo log.md](/notes/database/MySQL/InnoDB/InnoDB%20redo%20log/)
#### 2.2.5. Undo Logs
- 数据更改前的快照，可以用来回滚数据
- [InnoDB undo log.md](/notes/database/MySQL/InnoDB/InnoDB%20undo%20log/)
## 3. 参考
