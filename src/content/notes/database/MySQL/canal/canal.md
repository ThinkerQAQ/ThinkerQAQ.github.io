...
## 3. canal原理
- 本质上就是模拟主从复制的slave，所以跟[MySQL主从复制.md](/notes/database/MySQL/MySQL%E4%B8%BB%E4%BB%8E%E5%A4%8D%E5%88%B6/)一样
## 4. 如何使用canal
### 4.1. 单机版
#### 4.1.1. 搭建MySQL
1. 安装
    - [MySQL安装配置.md](/notes/database/MySQL/MySQL%E5%AE%89%E8%A3%85%E9%85%8D%E7%BD%AE/)
2. 开启MySQL主从复制
    - [MySQL主从复制.md](/notes/database/MySQL/MySQL%E4%B8%BB%E4%BB%8E%E5%A4%8D%E5%88%B6/)
3. 创建用户
    ```sql
