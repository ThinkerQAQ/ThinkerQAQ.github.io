---
title: "4.1 Zookeeper源码编译启动"
description: "1. 启动类是什么 - 从zkServer.sh 71行的位置里可以看出 - 启动后使用jps -l也可以看出 2. 源码启动 2.1. Ant环境 2.1.1. 配置Ant环境 - 下载 Apache Ant \\- Binary Distributions - 解压 - 配置PATH - 测试 2"
sourcePath: "Zookeeper/源码分析/Zookeeper源码编译启动.md"
category: "zookeeper"
...
order: 11
tags: ["Zookeeper"]
createdAt: "2020-04-01T08:33:58Z"
updatedAt: "2020-04-02T08:34:56Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
- clone
```git
git clone [已脱敏邮箱]:apache/zookeeper.git
```
- ant编译
```
ant eclipse
