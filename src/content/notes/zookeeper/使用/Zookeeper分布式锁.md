---
title: "2.1 Zookeeper分布式锁"
description: "1. Zookeeper分布式锁实现 1.1. 基于Apache Curator - maven - 例子 1.1.1. 注意点 只有同一个线程的同一个InterProcessSemaphoreMutex实例才能加锁解锁 说明如下 1. 同一个线程创建两个实例, 两个都加锁 2. 同一个线程创建两个"
sourcePath: "Zookeeper/使用/Zookeeper分布式锁.md"
category: "zookeeper"
...
updatedAt: "2022-02-25T03:49:14Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
public static void main(String[] args) throws Exception {
    ...
    CuratorFramework client = CuratorFrameworkFactory.newClient("[已脱敏内网地址]:2181,[已脱敏内网地址]:2181,[已脱敏内网地址]:2181", retryPolicy);
    client.start();
