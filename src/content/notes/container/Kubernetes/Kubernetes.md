---
title: "2.Kubernetes"
description: "1. Kubernetes历史 Docker公司推出了Docker Swarm，开启PaaS战略，优势在于与Docker生态的无缝整合 Mesos公司推出了Marathon，优势在于大规模集群的调度与管理 Google基于内部的Borg 和 Omega 系统，推出了Kubernetes，优势在于设计"
sourcePath: "Container/Kubernetes/Kubernetes.md"
category: "container"
categoryLabel: "Docker / Kubernetes"
topic: "Kubernetes"
topicLabel: "2.Kubernetes"
order: 2
tags: ["Container"]
updatedAt: "2026-09-08T13:54:02Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
> 2026 注：这一点已经过时；当前 kubeadm 已支持高可用 control plane 的部署流程。
...
8. 把 ca.crt 等 Master 节点的重要信息，通过 ConfigMap 的方式保存在 Etcd 当中，供后续部署 Node 节点使用
...
> 2026 注：现代 Kubernetes 文档通常使用 control plane，不再推荐 Master 这一术语。
...
> 2026 注：Namespace 主要提供资源作用域；完整隔离还需要 RBAC、NetworkPolicy、ResourceQuota 等机制。
