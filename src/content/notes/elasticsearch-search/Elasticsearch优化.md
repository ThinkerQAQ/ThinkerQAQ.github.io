---
title: "1.5 Elasticsearch优化"
description: "1. 设计调优 - 创建mapping阶段 - 设计合理的字段，使用Java封装复杂的操作，直接写入到ES中。避免复杂操作，如join、nested、parent-child等 - 设置最小的最合适的数据类型。byte，short，integer，long。如果最小的类型就合适，那么就用最小的类型。"
sourcePath: "Search_Server/Elasticsearch/Elasticsearch优化.md"
...
updatedAt: "2022-06-28T12:59:08Z"
status: "historical"
language: "zh"
featured: false
indexable: true
