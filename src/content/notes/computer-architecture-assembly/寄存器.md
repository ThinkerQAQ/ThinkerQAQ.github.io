---
title: "1.3 寄存器"
description: "x86-64 寄存器学习笔记，包括通用寄存器、RIP、段寄存器与栈相关寄存器。"
sourcePath: "Computer_Composition_Principle/寄存器.md"
...
createdAt: "2020-08-23T15:09:32Z"
updatedAt: "2020-08-23T15:41:59Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
- rax, rbx, rcx, rdx, rsi, rdi, rbp, rsp, r8, r9, r10, r11, r12, r13, r14, r15寄存器
    - rsp和rbp两个寄存器都跟函数调用栈有关
        ...
        - 举例参考[进程.md](/notes/operating-system/Linux/进程/进程/)
- 主要用于临时存放数据
