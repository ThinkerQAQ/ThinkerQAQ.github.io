---
title: "1.12 slice"
description: "1. slice 是什么 支持动态扩容的数组 2. 为什么需要 slice array 元素长度固定，无法动态扩容 3. 如何使用 slice 3.1. 基本使用 3.2. 函数传参是引用 - 虽然传的是引用，但是为了避免扩容后 slice 改变，函数返回 slice 3.3. nil slice "
sourcePath: "Golang/slice.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 12
tags: ["Golang"]
createdAt: "2020-08-09T10:56:42Z"
updatedAt: "2021-09-04T08:08:51Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
![](/media/vnote/go/attachments/20210904160255672_22310.png)
