---
title: "2.5 sync.pool"
description: "1. 是什么 保存temp object的pool。 temp表示这个对象可能会被回收，所以这个pool其实就是个cache 2. 为什么需要 将暂时不用的对象缓存起来，待下次需要的时候直接使用 这样就不用经过内存分配，减轻GC的压力 3. 怎么使用 3.1. fmt - Printf - Fpri"
sourcePath: "Golang/sync.pool.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 18
tags: ["Golang"]
createdAt: "2020-08-26T15:04:35Z"
updatedAt: "2022-12-04T13:13:47Z"
status: "historical"
language: "zh"
featured: false
indexable: true
