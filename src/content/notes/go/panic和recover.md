---
title: "1.9 panic和recover"
description: "1. 是什么 - panic是内置函数，可以停止正常的流程。 - recover是内置函数，可以捕获到panic，recover只在defer函数中有用。 2. 为什么需要 - panic一般用于不可恢复的错误，让程序不能继续进行 - recover为了防止panic之后整个进程都down掉，这个时"
sourcePath: "Golang/panic和recover.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 9
tags: ["Golang"]
createdAt: "2020-08-31T15:27:29Z"
updatedAt: "2020-09-05T04:32:33Z"
status: "historical"
language: "zh"
featured: false
indexable: true
