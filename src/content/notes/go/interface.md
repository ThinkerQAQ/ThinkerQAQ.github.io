---
title: "1.4 interface"
description: "1. 有哪些 1.1. 空接口interface{} 可以接收任意类型的数据 它只要记录这个数据在哪儿，是什么类型的就足够了 1.1.1. 举例 底层结构如下 - 赋值 - 1.2. 非空接口 非空接口就是有方法列表的接口类型 一个变量要想赋值给一个非空接口类型，其类型必须要实现该接口要求的所有方法"
sourcePath: "Golang/interface.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 4
tags: ["Golang"]
createdAt: "2020-08-08T10:00:43Z"
updatedAt: "2021-04-22T15:08:54Z"
status: "historical"
language: "zh"
featured: false
indexable: true
