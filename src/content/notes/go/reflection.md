---
title: "1.2 reflection"
description: "1. 反射是什么 修改代码- 编译- 运行 正常来说我们要修改代码只能在编译前，反射能让我们在运行时修改代码 2. Golang如何实现反射 interface 当向interface变量赋予一个实体类型的时候，interface会存储实体的类型信息，反射就是通过interface的类型信息实现的 "
sourcePath: "Golang/reflection.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 2
tags: ["Golang"]
createdAt: "2020-04-28T07:02:08Z"
updatedAt: "2022-11-25T13:17:35Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
[interface.md](/notes/go/interface/)
