---
title: "2.6 select"
description: "1. 是什么 - 类似于IO多路复用 - 监听多个阻塞的事件，如果事件发生了，那么执行该事件逻辑 - 如果没有发生并有默认的事件，那么执行默认的事件逻辑 - 如果没有发生且没有默认的事件，那么一直阻塞 2. 使用 2.1. 基本使用 代码执行到 select 时，case 语句会按照源代码的顺序被评"
sourcePath: "Golang/select.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 19
tags: ["Golang"]
createdAt: "2020-08-31T15:29:01Z"
updatedAt: "2024-02-03T04:46:39Z"
status: "historical"
language: "zh"
featured: false
indexable: true
