...
description: "1. 内存泄露 内存泄露.md 2. Golang内存泄露 2.1. root对象引用 2.2. goroutine 泄漏 goroutine泄露：原理、场景、检测和防范 \\- SegmentFault 思否 - 如果你启动了一个 goroutine，但并没有符合预期的退出，那么直到程序结束这个go"
...
2. 使用pprof分析
    1. `go tool pprof http://xxx/debug/pprof/heap?debug=1`查看[runtime.MemStat](/notes/go/%E5%86%85%E5%AD%98%E7%AE%A1%E7%90%86/)。
