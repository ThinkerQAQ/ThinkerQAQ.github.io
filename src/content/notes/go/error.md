---
title: "1.3 error"
description: "1. exception和error Golang把错误分成exception和error - exception是严程序内部的BUG或者不可预料的情况 - error则是可以预期的，通过一个返回值来判断 2. 使用 2.1. exception - 内部BUG通过recovery捕获转换成erro"
sourcePath: "Golang/error.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 3
tags: ["Golang"]
createdAt: "2020-04-29T10:22:12Z"
updatedAt: "2022-10-30T08:14:02Z"
status: "historical"
language: "zh"
featured: false
indexable: true
