---
title: "2.7 sync.Once"
description: "1. 是什么 Once 是一个对象,它提供了保证某个动作只被执行一次功能 说白了就是使方法只执行一次 2. 使用 2.1. 单例模式 单例模式.md 3. 原理 通过sync.atomic+sync.Mutex实现 - Do 方法为什么不直接 o.done == 0 而要使用 atomic.Load"
sourcePath: "Golang/sync.Once.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 20
tags: ["Golang"]
createdAt: "2020-09-06T09:18:25Z"
updatedAt: "2021-05-10T14:17:49Z"
status: "historical"
language: "zh"
featured: false
indexable: true
