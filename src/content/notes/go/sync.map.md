---
title: "2.4 sync.map"
description: "1. sync.map是什么 - 线程安全的Map - 底层使用乐观锁实现，所以适用竞争不大的场景 - 一次写多次读，如缓存的场景 - 多个goroutine读写的是没有交集的key 1.1. 并发安全的思路 - 加一把大锁 - 把map分成若干map，只操作小map 2. 使用 3. 源码分析 3"
sourcePath: "Golang/sync.map.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 17
tags: ["Golang"]
createdAt: "2020-08-26T15:04:12Z"
updatedAt: "2022-06-28T11:23:43Z"
status: "historical"
language: "zh"
featured: false
indexable: true
