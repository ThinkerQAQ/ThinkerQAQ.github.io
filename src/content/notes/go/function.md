---
title: "1.5 function"
description: "1. 是什么 - 函数是一等公民 - 有具名函数、匿名函数 - 把函数绑定在struct上就成了方法 2. 使用 2.1. 可变参数 2.2. 多返回值 go语言的函数可以返回多个值 2.2.1. 原理 - C语言的实现 在调用函数中分配返回值的空间，并将返回值的指针传给被调函数 - Go语言的实现"
sourcePath: "Golang/function.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 5
tags: ["Golang"]
createdAt: "2020-08-09T10:32:49Z"
updatedAt: "2020-10-05T02:28:04Z"
status: "historical"
language: "zh"
featured: false
indexable: true
