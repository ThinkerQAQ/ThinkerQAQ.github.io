---
title: "3.3 Go构建过程"
description: "1. 文本文件 保存之后这个文件以二进制形式存储在磁盘中 使用vim打开，敲入 :%!xxd 最左边的地址列，中间是文本字符对应的十六进制ASCII编码，最右边是文本字符。 ASCII表可以通过 man ascii 查询 像这种把二进制通过字符表转换成人类可读的文件叫做文本文件，不可读的就是二进制文"
sourcePath: "Golang/Go构建过程.md"
category: "go"
categoryLabel: "Go"
topic: "runtime"
...
order: 31
tags: ["Golang"]
createdAt: "2020-08-22T02:36:27Z"
updatedAt: "2020-09-11T14:58:52Z"
status: "historical"
language: "zh"
featured: false
indexable: true
