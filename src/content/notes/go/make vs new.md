---
title: "1.1 make vs new"
description: "1. 是什么 golang的内置函数 2. 为什么需要 分配内存空间 值类型的声明之后即可使用 引用类型的则需要分配空间 3. 使用 3.1. new 开辟一段内存，并置为零值，返回指向该类型内存地址的指针 3.1.1. 相当于&结构体{} 3.2. make 用于创建slice、map和chann"
sourcePath: "Golang/make vs new.md"
category: "go"
categoryLabel: "Go"
topic: "language"
...
order: 1
tags: ["Golang"]
createdAt: "2020-04-24T03:11:50Z"
updatedAt: "2022-05-03T07:42:33Z"
status: "historical"
language: "zh"
featured: false
indexable: true
