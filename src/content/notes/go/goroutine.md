---
title: "2.14 goroutine"
description: "1. goroutine是什么 - 程序、进程、线程.md - Go语言实现的用户线程 - 相比较于线程，goroutine - 创建、销毁和切换：都在用户态完成无需进入内核 - 内存占用：默认栈大小为2K，并且可以动态扩缩容 2. goroutine使用 2.1. 创建协程 - go f(x, y"
sourcePath: "Golang/goroutine.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 27
tags: ["Golang"]
createdAt: "2020-08-09T09:27:45Z"
updatedAt: "2022-03-20T12:43:55Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
### 2.2. 协程池
[协程池.md](/notes/go/%E5%8D%8F%E7%A8%8B%E6%B1%A0/)
## 3. goroutine原理
```go
func TestGoroutine1(t *testing.T) {
	go func(x, y, z int) {
