---
title: "2.1 context"
description: "1. context goroutine的上下文，在 goroutine 之间传递上下文信息，包括：取消信号、超时时间、截止时间、k-v 等。 控制并发的其中一种方式，另外一种是sync.WaitGroup.md 2. 使用 2.1. deadlines：超时取消 2.2. cancellation"
sourcePath: "Golang/context.md"
category: "go"
categoryLabel: "Go"
topic: "concurrency"
...
order: 14
tags: ["Golang"]
createdAt: "2020-05-24T05:20:46Z"
updatedAt: "2022-06-15T14:41:19Z"
status: "historical"
language: "zh"
featured: false
indexable: true
...
控制并发的其中一种方式，另外一种是[sync.WaitGroup.md](/notes/go/sync.WaitGroup/)
