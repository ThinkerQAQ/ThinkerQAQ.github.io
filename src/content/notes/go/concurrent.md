...
description: "1. 有什么 1.1. goroutine+channel - goroutine.md - channel.md 1.2. sync包 sync.md 2. 同步 2.1. 顺序一致性模型 同一个Goroutine线程内部，顺序一致性内存模型是得到保证的 2.2. happens-before 不"
