...
export const REVIEWED_NOTE_PATHS = {
  ...
  Database: new Set([
    "Database/MySQL/InnoDB/InnoDB Buffer Pool.md",
    "Database/MySQL/InnoDB/InnoDB MVCC.md",
    "Database/MySQL/InnoDB/InnoDB redo log.md",
    "Database/MySQL/InnoDB/InnoDB undo log.md",
    "Database/MySQL/InnoDB/InnoDB事务.md",
    "Database/MySQL/InnoDB/InnoDB和MyISAM索引对比.md",
    "Database/MySQL/InnoDB/InnoDB表空间.md",
    "Database/MySQL/InnoDB/MySQL Flush.md",
    "Database/MySQL/InnoDB/MySQL InnoDB.md",
    "Database/MySQL/MySQL InnoDB Buffer Pool.md",
    "Database/MySQL/MySQL SQL调优.md",
    "Database/MySQL/MySQL bin-log.md",
    "Database/MySQL/MySQL explain.md",
    "Database/MySQL/MySQL show profile.md",
    "Database/MySQL/MySQL.md",
    "Database/MySQL/MySQL主从复制.md",
    "Database/MySQL/MySQL分析器.md",
    "Database/MySQL/MySQL压测.md",
    "Database/MySQL/MySQL存储引擎.md",
    "Database/MySQL/MySQL安装配置.md",
    "Database/MySQL/MySQL慢查询日志.md",
    "Database/MySQL/MySQL执行器.md",
    "Database/MySQL/MySQL数据类型.md",
    "Database/MySQL/MySQL文件系统.md",
    "Database/MySQL/MySQL架构.md",
    "Database/MySQL/MySQL查询优化器.md",
    "Database/MySQL/MySQL索引.md",
    "Database/MySQL/MySQL索引底层实现.md",
    "Database/MySQL/MySQL线上问题排查.md",
    "Database/MySQL/MySQL统计数据.md",
    "Database/MySQL/MySQL表访问方法.md",
    "Database/MySQL/MySQL调优.md",
    "Database/MySQL/MySQL连接器.md",
    "Database/MySQL/MySQL锁.md",
    "Database/MySQL/MySQL页.md",
    "Database/MySQL/canal/canal.md",
    "Database/MySQL/云MySQL.md",
    "Database/MySQL/系统数据库.md",
